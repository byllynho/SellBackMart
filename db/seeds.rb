...
item_1 = user_1.items.build(title:'Apple Macbook',price:300.00,condition: 'used',category_id:2,description:'Its just 2 year old laptop. Good condition and latest upgraded OS',
    inactive:false)
